...
import 'package:teacher_rating/controller/teacher/profileController.dart';
...
class TeacherProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(TeacherProfile1Controller());
    return Scaffold(
      appBar: AppBar(
      ...
      body: Directionality(
          ...
          child: GetBuilder<TeacherProfile1Controller>(
                  ...
                  : Stack(
                      children: [
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Flexible(
                                              child: Text(
                                                "${controller.data['teacher_contact']}",
                                                maxLines: 3,
                                                overflow: TextOverflow.visible,
                                                textAlign: TextAlign.start,
                                                style: TextStyle(
                                                    color: Color(0xFF1B6DB9)),
                                                softWrap: true,
                                              ),
                                            ),
                                            SizedBox(width: 20),
                        ...
                        Positioned(
                            ...
                            right: 140,
                            child: Text(
                              "${controller.data['teacher_first_name']} ${controller.data['teacher_last_name']}",
                              style: TextStyle(
                        ...
                        Positioned(
                            ...
                            width: 110,
                            child: Text(
                              "${controller.data['teacher_geneal_spec']}",
                              style: TextStyle(
                                  fontSize: 13,
                                  color: Colors.white,
